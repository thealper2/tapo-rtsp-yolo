...
def apply_wiener_filter(frame, kernel_size=5):
    return wiener(frame, (kernel_size, kernel_size))
...
while True:
    ...
    denoised_frame = apply_wiener_filter(gray_frame)
    denoised_frame = np.uint8(denoised_frame)
